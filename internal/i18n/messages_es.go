...
func getSpanishMessages() map[MessageKey]string {
	return map[MessageKey]string{
		...
		MsgErrorGettingBackupDir:  "Error al obtener directorio de respaldos: %v",
		MsgErrorListingBackups:    "Error al listar respaldos: %v",
		MsgErrorLoadingBackup:     "Error al cargar respaldo '%s': %v",
		MsgErrorDeletingBackup:    "Error al eliminar respaldo: %v",
		MsgNoBackupsFound:         "No se encontraron respaldos",
		MsgAvailableBackups:       "Respaldos Disponibles",
		MsgTimestamp:              "Fecha y hora",
		MsgCommand:                "Comando",
		MsgFiles:                  "Archivos",
		MsgTotalBackups:           "Total de respaldos",
		MsgRestoringBackup:        "Restaurando respaldo",
		MsgBackupCreated:          "Respaldo creado",
		MsgFilesToRestore:         "Archivos a restaurar",
		MsgFilesInBackup:          "Archivos en el respaldo:",
		MsgRestoringFiles:         "Restaurando archivos...",
		MsgRestoreFailed:          "Restauración fallida: %v",
		MsgRestoreComplete:        "Restauración completada exitosamente",
		MsgDeletingBackup:         "Eliminando respaldo",
		MsgBackupDeleted:          "Respaldo eliminado: %s",
		MsgBackupInProgress:       "Creando respaldo...",
		MsgBackupComplete:         "Respaldo completado: %s",
		MsgBackupFailed:           "Respaldo fallido: %v",
		MsgBackingUpFile:          "Respaldando: %s",
